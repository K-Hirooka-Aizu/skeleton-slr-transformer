"""
https://github.com/suvajit-patra/sl-hwgat/blob/main/hwgat/pose_modules/RTMWPose.py
"""
import os
import numpy as np
...
class Model:
    def __init__(self, config_file=None, checkpoint_file=None, device='cuda:0') -> None:
        ...
        if self.config_file is None:
            self.config_file = os.path.join(os.environ["HOME"],'mmpose/configs/wholebody_2d_keypoint/rtmpose/cocktail14/rtmw-x_8xb704-270e_cocktail14-256x192.py')
        if self.checkpoint_file is None:
            self.checkpoint_file = os.path.join(os.environ["HOME"],'mmpose/pose_modules/weights/rtmw-x_simcc-cocktail14_pt-ucoco_270e-256x192-13a2546d_20231208.pth')
        self.device = device
